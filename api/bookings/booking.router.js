const { createBooking, updateBooking, updateBookingStatus, deleteBooking, getAllProfessionalBookings, getAllUserBookings, getAllBookings, cancelBooking} = require("./booking.controller");
